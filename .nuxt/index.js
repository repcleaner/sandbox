...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.client && typeof nuxt_plugin_vueowlcarousel_a85119da === 'function') {
    await nuxt_plugin_vueowlcarousel_a85119da(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_aftereach_0f196ff1 === 'function') {
    await nuxt_plugin_aftereach_0f196ff1(app.context, inject)
  }
